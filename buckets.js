...
const load = exports.load = () => {
  ...
  if( stored_config ) {
    ...
    if( !( (settings.multipong.min_price === stored_config.min_price) && (settings.multipong.max_price === stored_config.max_price) && (settings.multipong.num_buckets === stored_config.num_buckets) ) ) {
      ...
      .find()
      .sort( (a, b) => {
        // cheap->expensive TODO: flip this?
